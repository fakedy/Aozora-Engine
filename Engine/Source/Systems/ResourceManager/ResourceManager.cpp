...
namespace Aozora {
    ...
    const aiScene* ResourceManager::importFile(const std::string& file)
    {
    ...
    void ResourceManager::processFile(const aiScene* scene)
    {

    }

    ResourceManager::MeshData ResourceManager::loadModel(const std::string& file)
    {
